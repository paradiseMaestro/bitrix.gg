...
<? endforeach; ?>
    ...
    <form 
    id='form' method="get" action="/catalog/<?=$urlArr[2]?>/"
    class="catalog-hero__activity" data-aos="fade-up"
    >

    
    <label 
    onclick="document.getElementById('form').submit()" 
    class="catalog-hero__tops desktop" for="top">
            <input value="is_top" <? if (isset($_GET["top"])):?>checked<?endif;?>
            ...
            <div class="catalog-hero__select desktop">
                <div class="select-wrapper">
                    <div class="select">
                        ...
                        class="select__select" style="width: 100%"
                        name="brends"
                            data-select-placeholder="Бренд">
                            <option value="" selected="selected" disabled="disabled"></option>
                            <?php foreach ($arResult['brends_'] as $key=>$value): ?>
                                <option 
                                <?if($_GET['brends'] == $value['ID']):?> selected="selected"<?endif;?>
                                value="<?=$value['ID']?>">
                                    <?=$value['NAME']?>
                                </option>
                            <?php endforeach; ?>
                ...
                <div class="select-wrapper">
                    <div class="select">
                        ...
                        class="select__select" style="width: 100%"
                            ...
                            <option value="" selected="selected" disabled="disabled"></option>
                            <?php foreach ($arResult['fat_content'] as $value): ?>
                                <option 
                                <?if($_GET['fat_content'] == $value[1]):?>
                ...
                <div class="select-wrapper">
                    <div class="select cstm-arrows">
                        ...
                        class="select__select" style="width: 100%"
                            ...
                            <option value="" selected="selected" disabled="disabled"></option>
                            <?php foreach ($arResult['sort'] as $value): ?>
                                <option 
                                <?if($_GET['sort'] == $value[1]):?>
                                selected="selected"<?endif;?>
                                value="<?=$value[1]?>">
                                    <?=$value[0]?>
                                </option>
        ...
        <div class="catalog-hero__reset desktop">
            ...
            class="catalog-hero__reset-text">Сбросить</div>
        </div>
    </form>
</section>
