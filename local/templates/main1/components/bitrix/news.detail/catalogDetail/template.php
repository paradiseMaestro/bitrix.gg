...
<div class="catalog-detail__form" data-aos="fade-up">
	...
	<div class="catalog-detail__form-content">
		<form class="partners-requisites__form"
		method ="POST"
		
		data-form="catalog-detail">
		<?=bitrix_sessid_post()?>
			...
			<div class="partners-requisites__form-top">
				<div class="input-wrapper" data-input-parent="">
					...
					<input 
					name = "name"
					class="input" data-input="" required data-mask-text="" data-parsley-pattern="^[А-Яа-яЁё -]+$" placeholder="Имя">
				</div>
				<div class="input-wrapper" data-input-parent="">
					<div class="input-wrapper__placeholder">Телефон</div>
					<input
					name = "phone"
					class="input" data-input="" required type="tel" placeholder="Телефон" data-mask-phone="">
				</div>
				<div class="input-wrapper" data-input-parent="">
					<div class="input-wrapper__placeholder">E-mail</div>
					<input
					name = "email"
					class="input" data-input="" required type="email" placeholder="E-mail">
				</div>
			</div>
			...
			<div class="partners-requisites__form-area">
				<div class="input-wrapper input-wrapper_textarea" data-input-parent="">
					<div class="input-wrapper__placeholder placeholder_background">
						Комментраий к заявке</div>
						<textarea
						name = "text"
						class="textarea" data-input="" type="text" placeholder="Комментраий к заявке"></textarea>
				</div>
			</div>
			<div class="partners-requisites__form-bot">
				<div class="partners-requisites__form-policy">Нажимая на кнопку «Отправить», вы даете согласие с
					<a class="partners-requisites__form-link" href="#"> политикой в отношении обработки персональных данных</a></div>
...
<section class="catalog-detail top-section container">
	...
	<div class="catalog-detail__inner">
		...
		<div class="catalog-detail__col info" data-aos="fade-up">
			...
			<a class="catalog-detail__rect btn-hover_parent" 
				href="<?=$arResult['PROPERTIES']['next_element']['next']['DETAIL_PAGE_URL']?>"
				>
				...
				<div class="catalog-detail__rect-inner">
					<div class="catalog-detail__rect-texts">
						<div class="catalog-detail__rect-title">
						<?=$arResult['PROPERTIES']['next_element']['NAME']?>
						</div>
						<div class="catalog-detail__rect-desk">
						<?=$arResult['PROPERTIES']['next_element']['next']['NAME']?>
						</div>
					</div>
					<div class="catalog-detail__rect-box">
						<div class="catalog-detail__rect-img">
							<picture class="picture">
								<img class="picture__img" src="<?=$arResult['PROPERTIES']['next_element']['next']['PICTURE']['src']?>">
							</picture>
						</div>
					</div>
				</div>
